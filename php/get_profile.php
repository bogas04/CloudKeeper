...
respond(false, 'Profile data', $_SESSION['user']);
//$mysqli = dbConnect();

//$owner_id = $_SESSION['user']['owner_id'];
//$query = 'SELECT first_name as firstName, last_name as lastName, username, owner_id FROM `owner` WHERE `owner_id` = "'. $owner_id.'"';
