...
$query = "SELECT invoices.invoice_id, shops.name as `shop name`, invoices.invoice_amount as `invoice amount`, invoices.invoice_time as `invoice time` FROM `invoices`, `invoice_items`, `shops` WHERE ".
